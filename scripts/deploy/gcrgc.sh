...
# Credit: https://gist.github.com/ahmetb/7ce6d741bd5baa194a3fac6b1fec8bb7

#
# For us, to get all images for a given repo, run command like these
# 1. Get all images
# gcloud container images list
#
# 2. Get all revisions of an image 
# gcloud container images list-tags gcr.io/consummate-mark-229518/webapp
#
# 3. Delete old ones
...
EXAMPLE
  gcrgc.sh gcr.io/consummate-mark-229518/webapp 2022-04-01
