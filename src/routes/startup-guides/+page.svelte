		...
		<div class="row">
			<div class="col-xl-12">
				<div class="blog-carousel">
					<a href="/startup-guides/slug-of-blog" class="blog-compact-item-container">
	...
	<div class="container">
		<div class="row">
			<div class="col-xl-8 col-lg-8">
				...
				<!-- Blog Post -->
				<a href="/startup-guides/slug-of-blog" class="blog-post">
					<!-- Blog Post Thumbnail -->
				...
				<div class="sidebar-container margin-top-65">
					...
					<div class="sidebar-widget">
						...
						<ul class="widget-tabs">
							<!-- Post #1 -->
							<li>
								<a href="/startup-guides/slug-of-blog" class="widget-content active">
									<img src="images/blog-02a.jpg" alt="" />
							...
							<!-- Post #2 -->
							<li>
								<a href="/startup-guides/slug-of-blog" class="widget-content">
									<img src="images/blog-07a.jpg" alt="" />
									<div class="widget-text">
					...
					<div class="sidebar-widget">
						...
						<div class="freelancer-socials margin-top-25">
							<ul>
								<li>
									<a href="#" title="Dribbble"><i class="icon-brand-dribbble" /></a>
								</li>
								<li>
									<a href="#" title="Twitter"><i class="icon-brand-twitter" /></a>
								</li>
								<li>
									<a href="#" title="Behance"><i class="icon-brand-behance" /></a>
								</li>
								<li>
									<a href="#" title="GitHub"><i class="icon-brand-github" /></a>
								</li>
							</ul>
						</div>
					</div>
