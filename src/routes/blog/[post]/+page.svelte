							...
							<li>
								...
								<ul class="dropdown-nav">
									<li>
										...
										<ul class="dropdown-nav">
											<li>
												<a href="jobs-list-layout-full-page-map.html">Full Page List + Map</a>
											</li>
											<li>
												<a href="jobs-grid-layout-full-page-map.html">Full Page Grid + Map</a>
											</li>
							...
							<li>
								...
								<ul class="dropdown-nav">
									<li>
										...
										<ul class="dropdown-nav">
											<li>
												<a href="freelancers-grid-layout-full-page.html">Full Page Grid</a>
											</li>
								...
								<ul class="dropdown-nav">
									<li>
										...
										<ul class="dropdown-nav">
											...
											<li>
												<a href="single-company-profile-OpenStreetMap.html">Company Profile</a>
											</li>
											<li><a href="pages-contact-OpenStreetMap.html">Contact</a></li>
											<li>
												<a href="jobs-list-layout-1-OpenStreetMap.html">Location Autocomplete</a>
											</li>
										</ul>
									</li>
									...
									<li>
										<a href="pages-user-interface-elements.html">User Interface Elements</a>
									</li>
										...
										<ul>
											...
											<li class="notifications-not-read">
												<a href="dashboard-manage-candidates.html">
													<span class="notification-icon"
														><i class="icon-material-outline-group" /></span
													>
													<span class="notification-text">
														<strong>Michael Shannah</strong> applied for a job
														<span class="color">Full Stack Software Engineer</span>
													</span>
												</a>
											</li>
											...
											<li>
												<a href="dashboard-manage-bidders.html">
													<span class="notification-icon"
														><i class=" icon-material-outline-gavel" /></span
													>
													<span class="notification-text">
											...
											<li>
												<a href="dashboard-manage-jobs.html">
													<span class="notification-icon"
														><i class="icon-material-outline-autorenew" /></span
													>
													<span class="notification-text">
						...
						<div class="header-notifications">
							...
							<div class="header-notifications-dropdown">
									...
									<div class="header-notifications-scroll" data-simplebar>
										<ul>
											...
											<li class="notifications-not-read">
												<a href="dashboard-messages.html">
													<span class="notification-avatar status-online"
														><img src="images/user-avatar-small-03.jpg" alt="" /></span
													>
											...
											<li class="notifications-not-read">
												<a href="dashboard-messages.html">
													<span class="notification-avatar status-offline"
														><img src="images/user-avatar-small-02.jpg" alt="" /></span
													>
													<div class="notification-text">
											...
											<li class="notifications-not-read">
												<a href="dashboard-messages.html">
													<span class="notification-avatar status-online"
														><img src="images/user-avatar-placeholder.png" alt="" /></span
													>
													<div class="notification-text">
								...
								<a
									...
									>View All Messages<i class="icon-material-outline-arrow-right-alt" /></a
								>
							</div>
						</div>
					</div>
								...
								<ul class="user-menu-small-nav">
									<li>
										<a href="dashboard.html"
											><i class="icon-material-outline-dashboard" /> Dashboard</a
										>
									</li>
									<li>
										<a href="dashboard-settings.html"
											><i class="icon-material-outline-settings" /> Settings</a
										>
									</li>
									<li>
										<a href="index-logged-out.html"
											><i class="icon-material-outline-power-settings-new" /> Logout</a
										>
									</li>
								</ul>
							</div>
			...
			<div class="col-xl-8 col-lg-8">
				...
				<div class="blog-post single-post">
					...
					<div class="blog-post-content">
						...
						<p>
							Nam nisl lacus, dignissim ac tristique ut, scelerisque eu massa. Vestibulum ligula
							nunc, rutrum in malesuada vitae, tempus sed augue. Curabitur quis lectus quis augue
							dapibus facilisis. Vivamus tincidunt orci est, in vehicula nisi eleifend ut.
						...
						<p>
							...
							Nulla eu mi magna. Etiam suscipit commodo gravida. Cras suscipit, quam vitae
							adipiscing faucibus, risus nibh laoreet odio, a porttitor metus eros ut enim. Morbi
							augue velit, tempus mattis dignissim nec, porta sed risus. Donec eget magna eu lorem
							tristique pellentesque eget eu dui. Fusce lacinia tempor malesuada. Ut lacus sapien,
							placerat a ornare nec, elementum sit amet felis. Maecenas pretium lorem hendrerit eros
							sagittis fermentum.
						</p>
						...
						<p>
							...
							magnis dis parturient montes, nascetur ridiculus mus. Integer vitae ante enim. Fusce
							sed elit est. Suspendisse sit amet mauris in quam pretium faucibus et aliquam odio.
						</p>

						<!-- Share Buttons -->
						<div class="share-buttons margin-top-25">
							<div class="share-buttons-trigger"><i class="icon-feather-share-2" /></div>
								...
								<ul class="share-buttons-icons">
									<li>
										<a
											...
											data-tippy-placement="top"><i class="icon-brand-facebook-f" /></a
										>
									</li>
									<li>
										<a
											...
											data-tippy-placement="top"><i class="icon-brand-twitter" /></a
										>
									</li>
									<li>
										<a
											...
											data-tippy-placement="top"><i class="icon-brand-google-plus-g" /></a
										>
									</li>
									<li>
										<a
											...
											data-tippy-placement="top"><i class="icon-brand-linkedin-in" /></a
										>
									</li>
								</ul>
							</div>
							...
							<div class="blog-compact-item">
								...
								<div class="blog-compact-item-content">
									...
									<p>
										...
										capital. Interactively front-end.
									</p>
								</div>
							</div>
						</a>
							...
							<ul>
								<li>
									...
									<div class="comment-content">
										...
										<div class="comment-by">
											Kathy Brown<span class="date">12th, June 2019</span>
											<a href="#" class="reply"><i class="fa fa-reply" /> Reply</a>
										</div>
										<p>
									...
									<ul>
										<li>
											...
											<div class="comment-content">
												<div class="arrow-comment" />
												<div class="comment-by">
													Tom Smith<span class="date">12th, June 2019</span>
													<a href="#" class="reply"><i class="fa fa-reply" /> Reply</a>
												</div>
												<p>
													Rrhoncus et erat. Nam posuere tristique sem, eu ultricies tortor imperdiet
													vitae. Curabitur lacinia neque.
												</p>
											</div>
										</li>
										<li>
											...
											<ul>
												<li>
													...
													<div class="comment-content">
														<div class="arrow-comment" />
														<div class="comment-by">
															John Doe<span class="date">12th, June 2019</span>
															<a href="#" class="reply"><i class="fa fa-reply" /> Reply</a>
														</div>
														<p>Great template!</p>
													</div>
								...
								<li>
									...
									<div class="comment-content">
										<div class="arrow-comment" />
										<div class="comment-by">
											John Doe<span class="date">15th, May 2015</span>
											<a href="#" class="reply"><i class="fa fa-reply" /> Reply</a>
										</div>
										<p>
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<form method="post" id="add-comment">
							...
							<textarea name="comment-content" cols="30" rows="5" placeholder="Comment" />
						</form>
						...
						<button
							...
							type="submit"
							form="add-comment"
							>Add Comment <i class="icon-material-outline-arrow-right-alt" /></button
						>
					</div>
				</div>
				<!-- Leava a Comment / End -->
							...
							<ul>
								<li>
									<a href="#" title="Dribbble" data-tippy-placement="top"
										><i class="icon-brand-dribbble" /></a
									>
								</li>
								<li>
									<a href="#" title="Twitter" data-tippy-placement="top"
										><i class="icon-brand-twitter" /></a
									>
								</li>
								<li>
									<a href="#" title="Behance" data-tippy-placement="top"
										><i class="icon-brand-behance" /></a
									>
								</li>
								<li>
									<a href="#" title="GitHub" data-tippy-placement="top"
										><i class="icon-brand-github" /></a
									>
								</li>
							</ul>
						</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xl-4 col-lg-4 col-md-12">
						<h3><i class="icon-feather-mail" /> Sign Up For a Newsletter</h3>
						<p>Weekly breaking news, analysis and cutting edge advices on job searching.</p>
						<form action="#" method="get" class="newsletter">
							<input type="text" name="fname" placeholder="Enter your email address" />
							<button type="submit"><i class="icon-feather-arrow-right" /></button>
						</form>
					</div>
				</div>
			</div>
