...
<!-- Content
================================================== -->
<div id="titlebar" class="white margin-bottom-1">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h2>Guides</h2>
				<span>to help you ideate, get started, grow, and operate</span>
			</div>
		</div>
	</div>
</div>
...
<div class="section white padding-top-0 padding-bottom-60 full-width-carousel-fix">
	<div class="container">
		<div class="row">
			<div class="col-xl-12">
				<div class="blog-carousel" on:load={start}>
					<a href="/blog/post-title" class="blog-compact-item-container">
						<div class="blog-compact-item">
							...
							<div class="blog-compact-item-content">
								...
								<p>
									Distinctively reengineer revolutionary meta-services and premium architectures
	...
	<div class="container">
		<div class="row">
			<div class="col-xl-8 col-lg-8">
				...
				<!-- Blog Post -->
				<a href="/blog/post-title" class="blog-post">
					<!-- Blog Post Thumbnail -->
				...
				<div class="sidebar-container margin-top-65">
					...
					<div class="sidebar-widget">
						...
						<ul class="widget-tabs">
							<!-- Post #1 -->
							<li>
								<a href="/blog/post-title" class="widget-content active">
									<img src="images/blog-02a.jpg" alt="" />
							...
							<!-- Post #2 -->
							<li>
								<a href="/blog/post-title" class="widget-content">
									<img src="images/blog-07a.jpg" alt="" />
									<div class="widget-text">
